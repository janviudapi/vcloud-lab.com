...
variable "rdp_enabled" {
  description = "Enable RDP for the virtual machine"
  type        = bool
  default     = true
}

variable "init_powershell" {
  description = "(Optional) Initial PowerShell script to run on the virtual machine"
  type        = string
  default     = ""
}
...
variable "user_assigned_identity_id" {
  type        = string
  description = "The ID of the User Assigned Identity to associate with the Virtual Machine"
}